...
const CourseIdPage = async ({ params }: { params: { courseId: string } }) => {
    ...
    const caetgories = await db.category.findMany({
        orderBy: {
            name: "asc"
        }
    })
            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
                    <div>
                        ...
                        <CategoryForm initialData={course} courseId={course.id} options={caetgories.map((category) => ({ label: category.name, value: category.id }))} />
                    </div>
